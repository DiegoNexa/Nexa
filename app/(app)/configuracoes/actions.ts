...
const schema = z.object({
  ...
  // CPF (11) ou CNPJ (14). Não é exigido pela cobrança (a Stripe
  // coleta no checkout) — fica guardado para nota fiscal.
...
/**
 * Cria o checkout de assinatura e redireciona para a Stripe.
