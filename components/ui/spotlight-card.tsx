...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  useEffect(() => {
    // The spotlight tracks the mouse, so it only makes sense with a fine
    // pointer. On touch devices this handler would fire on every scroll
    // frame (writing CSS vars across all cards) — a major perf drain.
